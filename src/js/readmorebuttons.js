  ...
  item.addEventListener("click", (event) => {
    ...
    if (item.classList.contains("button-open")) {
      ...
      if (buttonOpenParent.className === "main-section__container") {
        ...
        if (
          window.matchMedia("(min-width: 768px) and (max-width: 1119px)")
            .matches
        ) {
          hiddenTextMainTablet.classList.toggle(
            "main-section__text--hidden-tablet"
          );
      ...
      if (buttonOpenParent.className === "brands") {
        ...
        for (let i = 0; i < brandsHiddenOnTablet.length; i++) {
          brandsHiddenOnTablet[i].classList.toggle(
            "swiper-slide--hidden--tablet"
          );
        }
        for (let i = 0; i < brandsHiddenOnDesktop.length; i++) {
          brandsHiddenOnDesktop[i].classList.toggle(
      ...
      if (buttonOpenParent.className === "repairs") {
        ...
        for (let i = 0; i < repairsHiddenOnTablet.length; i++) {
          repairsHiddenOnTablet[i].classList.toggle(
            "swiper-slide--hidden--tablet"
          );
        }
        for (let i = 0; i < repairsHiddenOnDesktop.length; i++) {
          repairsHiddenOnDesktop[i].classList.toggle(
            "swiper-slide--hidden--desktop"
          );
        }
